...
AMyActor::AMyActor() {
    ...
    static ConstructorHelpers::FObjectFinder<UStaticMesh> CubeMeshAsset(TEXT("/Engine/BasicShapes/Sphere.Sphere"));
...
void AMyActor::OnConstruction(const FTransform& Transform)
{
    ...
    if (CubeMesh)
    {
        UMaterialInterface* Mat = Cast<UMaterialInterface>(
            StaticLoadObject(UMaterialInterface::StaticClass(), nullptr, TEXT("/Engine/EngineDebugMaterials/BoneWeightMaterial.BoneWeightMaterial"))
        );
        if (Mat)
        {
